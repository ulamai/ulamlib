...
A good first contribution is to add one small helper lemma in
\texttt{UlamLib/ODE/Extendability.lean}, for example a self-extension or
restriction lemma for \texttt{IntegralCurveExtension}.
